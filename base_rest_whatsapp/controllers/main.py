...
class BaseRestWhatsappPrivateApiController(main.RestController):
	_root_path = "/base_rest_whatsapp_api/private/"
	_collection_name = "base.rest.whataspp.private.services"
	_default_auth = "user"
